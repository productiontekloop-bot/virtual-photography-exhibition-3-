...
export default function CentralHallway() {
  ...
  const hallwayArtworks: ArtworkData[] = useMemo(() => [
    // 1. South Wall - Left of Room 1 entrance (Red-boxed location right beside doorway)
    {
      ...
      artist: 'Yves Ades',
      year: '2024',
      image: '/images/hallway/art-1.jpg',
    ...
    // 2. South Wall - Next to Room 2 entrance
    {
      ...
      artist: 'Yves Ades',
      year: '2024',
      image: '/images/hallway/art-2.jpg',
      category: 'Corridor Gallery',
      room: 'hallway',
      wall: 'south',
    ...
    // 3. West Wall - Left of Room 5 door
    {
      ...
      artist: 'Yves Ades',
      year: '2024',
      image: '/images/hallway/art-3.jpg',
      category: 'Corridor Gallery',
      room: 'hallway',
      wall: 'west',
    ...
    // 4. North Wall - Next to Room 4 entrance
    {
      ...
      artist: 'Yves Ades',
      year: '2024',
      image: '/images/hallway/art-4.jpg',
      category: 'Corridor Gallery',
      room: 'hallway',
      wall: 'north',
    ...
    // 5. North Wall - Left of Room 3 entrance (Red-boxed location right beside doorway)
    {
      ...
      artist: 'Yves Ades',
      year: '2024',
      image: '/images/hallway/art-5.jpg',
      category: 'Corridor Gallery',
      room: 'hallway',
      wall: 'north',
